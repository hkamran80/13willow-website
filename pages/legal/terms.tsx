...
const TermsOfService: NextPage = () => {
    return (
        <Layout>
            <Head>
                <title>Terms of Service - Thirteenth Willow</title>
            </Head>
            ...
            <div className="mx-auto max-w-2xl">
                ...
                <div className="prose prose-invert mt-6 max-w-none prose-a:text-pink-700">
                    ...
                    <ul>
                        <li>
                            <a href="#agreement-to-terms">Agreement to Terms</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#apple-and-android-devices">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#informal-negotiations">
                                        Informal Negotiations
                                    </a>
                                </li>
                                <li>
                                    <a href="#binding-arbitration">
                                        Binding Arbitration
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#exceptions-to-informal-negotiations-and-arbitration">
                        ...
                        <li>
                            <a href="#electronic-communications-tranasactions-and-signatures">
                                Electronic Communications, Tranasactions, and
                                Signatures
                            </a>
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        behalf of an entity (“you”) and Thirteenth Willow
                        (&quot;<strong>Company</strong>,&quot; “
                        <strong>we</strong>,&quot; “<strong>us</strong>,&quot;
                        or “<strong>our</strong>”), concerning your access to
                        and use of the{" "}
                        <a href="https://13willow.com">https://13willow.com</a>{" "}
                    ...
                    <p>
                        ...
                        each such change. Please ensure that you check the
                        applicable Terms every time you use our Site so that you
                        understand which Terms apply. You will be subject to,
                        and will be deemed to have been made aware of and to
                        have accepted, the changes in any revised Terms of Use
                    ...
                    <p>
                        ...
                        have received parental permission to use the Site; (3)
                        you will not access the Site through automated or
                        non-human means, whether through a bot, script, or
                        otherwise; (4) you will not use the Site for any illegal
                        or unauthorized purpose; and (5) your use of the Site
                    ...
                    <h2 id="user-generated-contributions">
                        User Generated Contributions
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        following the terms of the Privacy Policy and your
                    ...
                    <h2 id="mobile-application-license">
                        Mobile Application License
                    </h2>
                    ...
                    <p>
                        ...
                        in these Terms of Use. You shall not: (1) except as
                    ...
                    <p>
                        ...
                        Site: (1) the license granted to you for our mobile
                        application is limited to a non-transferable license to
                        use the application on a device that utilizes the Apple
                    ...
                    <p>
                        ...
                        our{" "}
                        <a href="https://13willow.com/legal/privacy">
                            Privacy Policy
                        </a>
                        . By using the Site, you agree to be bound by our
                        Privacy Policy, which is incorporated into these Terms
                        of Use. Please be advised the Site is hosted in the
                        United States. If you access the Site from any other
                    ...
                    <p>
                        ...
                        <a href="www.adr.org">www.adr.org</a>. Your arbitration
                        ...
                        provide a statement of reasons unless requested by
                        either Party. The arbitrator must follow applicable law,
                        and any award may be challenged if the arbitrator fails
                        to do so. Except where otherwise required by the
                        applicable AAA rules or applicable law, the arbitration
                        will take place in Contra Costa County, California.
                    ...
                    <p>
                        ...
                        Contra Costa County, California, and the Parties hereby
                    ...
                    <p>
                        ...
                        LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $5.00
                    ...
                    <h2 id="electronic-communications-tranasactions-and-signatures">
                        Electronic Communications, Tranasactions, and Signatures
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        <a href="mailto:hkamran@13willow.com?subject=Questions%20About%20the%20Terms%20of%20Service">
