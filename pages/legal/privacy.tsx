...
const PrivacyPolicy: NextPage = () => {
    return (
        <Layout>
            <Head>
                <title>Privacy Policy - Thirteenth Willow</title>
            </Head>
            ...
            <div className="mx-auto max-w-2xl">
                ...
                <div className="prose prose-invert mt-6 max-w-none prose-a:text-pink-400">
                    <p>
                        ...
                        ,&quot; or &quot;<strong>our</strong>&quot;), describes
                        how and why we might collect, store, use, and/or share
                        (&quot;<strong>process</strong>&quot;) your information
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="https://13willow.com">13willow.com</a>, or
                            any website of ours that links to this privacy
                            notice
                        </li>
                        <li>
                            Download and use any of our applications (e.g.
                            Schedules) that links to this privacy notice
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        contact us at{" "}
                        <a href="mailto:hkamran@13willow.com?subject=Questions%20About%20the%20Privacy%20Policy">
                            hkamran@13willow.com
                        </a>
                        .
                    </p>
                    ...
                    <p>
                        ...
                        <a href="#table-of-contents">here</a> to go directly to
                        our table of contents.
                    </p>
                    <h3 id="what-personal-information-do-we-process">
                        What personal information do we process?
                    </h3>
                    <p>
                        When you visit, use, or navigate our Services, we may
                        process personal information depending on how you
                        interact with Thirteenth Willow and the Services, the
                        choices you make, and the products and features you use.
                        Click <a href="#what-information-do-we-collect">here</a>{" "}
                        to learn more.
                    </p>
                    <h3 id="do-we-process-any-sensitive-personal-information">
                        Do we process any sensitive personal information?
                    </h3>
                    <p>We do not process sensitive personal information.</p>
                    <h3 id="do-we-receive-any-information-from-third-parties">
                    ...
                    <p>
                        ...
                        <a href="#how-do-we-process-your-information">here</a>{" "}
                        to learn more.
                    </p>
                    <h3 id="in-what-situations-and-with-which-parties-do-we-share-personal-information">
                    ...
                    <p>
                        ...
                        <a href="#how-do-we-keep-your-information-safe">here</a>{" "}
                        to learn more.
                    </p>
                    <h3 id="what-are-your-rights">What are your rights?</h3>
                    <p>
                        Depending on where you are located, the applicable
                        privacy law may mean you have certain rights regarding
                        your personal information. Click{" "}
                        <a href="#what-are-your-privacy-rights">here</a> to
                        learn more.
                    </p>
                    <h3 id="how-do-i-exercise-my-rights">
                    ...
                    <p>
                        Want to learn more about what Thirteenth Willow does
                        with any information we collect? Click{" "}
                        <a href="#table-of-contents">here</a> to review the
                        notice in full.
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#how-do-we-process-your-information-1">
                                How Do We Process Your Information?
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#how-do-we-keep-your-information-safe-1">
                                How Do We Keep Your Information Safe?
                            </a>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#withdrawing-your-consent">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#ccpa-privacy-notice">
                                        CCPA Privacy Notice
                                    </a>
                                </li>
                                <li>
                                    <a href="#what-categories-of-personal-information-do-we-collect">
                                        What categories of personal information
                                        do we collect?
                                    </a>
                                </li>
                                <li>
                                    <a href="#how-do-we-use-and-share-your-personal-information">
                                        How do we use and share your personal
                                        information?
                                    </a>
                                </li>
                                <li>
                                    <a href="#will-your-information-be-shared-with-anyone-else">
                                        Will your information be shared with
                                        anyone else?
                                    </a>
                                </li>
                                <li>
                                    <a href="#your-rights-with-respect-to-your-personal-data">
                    ...
                    <p>
                        <em>
                            TL;DR — We collect personal information that you
                            provide to us.
                        </em>
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <p>
                                If you use our application(s), we also may
                                collect the following information if you choose
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>
                                        We automatically collect device
                                        information (such as your mobile device
                                        ID, model, and manufacturer), operating
                                        system, version information and system
                                        configuration information, device and
                                        application identification numbers,
                                        browser type and version, hardware model
                                        Internet service provider and/or mobile
                                        carrier, and Internet Protocol (IP)
                                        address (or proxy server). If you are
                                        using our application(s), we may also
                                        collect information about the phone
                                        network associated with your mobile
                                        device, your mobile device&apos;s
                                        operating system or platform, the type
                                        of mobile device you use, your mobile
                                        device&apos;s unique device ID, and
                                        information about the features of our
                                ...
                                <li>
                                    ...
                                    <p>
                                        ...
                                        notifications regarding your account or
                                        certain features of the application(s).
                                        If you wish to opt out from receiving
                                        these types of communications, you may
                    ...
                    <p>
                        <em>
                            TL;DR – We process your information to provide,
                    ...
                    <p>
                        <em>
                            TL;DR – We may share information in specific
                        ...
                        <li>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="https://umami.is/docs/about">
                                                Umami
                                            </a>
                                        </td>
                                        <td>Analytics</td>
                    ...
                    <p>
                        <em>
                            TL;DR — We keep your information for as long as
                    ...
                    <p>
                        <em>
                            TL;DR — We aim to protect your personal information
                    ...
                    <p>
                        <em>
                            TL;DR – You may review, change, or terminate your
                            account at any time.
                        </em>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        for the data protection authorities are available{" "}
                        <a href="https://www.edoeb.admin.ch/edoeb/en/home.html">
                            here
                        </a>
                        .
                    </p>
                    <h3 id="withdrawing-your-consent">
                        Withdrawing your consent
                    </h3>
                    <p>
                    ...
                    <p>
                        <em>
                            TL;DR — Yes, if you are a resident of California,
                    ...
                    <h3 id="what-categories-of-personal-information-do-we-collect">
                    ...
                    <p>
                        ...
                        these categories through instances where you interact
                    ...
                    <h3 id="how-do-we-use-and-share-your-personal-information">
                    ...
                    <h3 id="will-your-information-be-shared-with-anyone-else">
                    ...
                    <p>
                        Thirteenth Willow has not sold any personal information
                        to third parties for a business or commercial purpose in
                        the preceding twelve (12) months. Thirteenth Willow has
                    ...
                    <p>
                        ...
                        purpose can be found under the{" "}
                        <a href="#when-and-with-whom-do-we-share-your-personal-information">
                            &quot;When and With Whom Do We Share Your Personal
                            Information&quot; section
                        </a>
                    </p>
                    <h3 id="your-rights-with-respect-to-your-personal-data">
                    ...
                    <p>
                        <em>
                            TL;DR — Yes, we will update this notice as necessary
